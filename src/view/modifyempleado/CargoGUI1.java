 ...
 */
public class CargoGUI1 extends javax.swing.JFrame {
    ...
    public void actualizarCargo() throws SQLException{
        ...
        ArrayList<DatosEmpleados> lista = c.datosModificacionCargo();
        ...
        if(tfUsuario.getText().length()!=0
            ...
            if(user.equals(tfUsuario.getText())){
                if(contra.equals(tfContrasenia.getText())){
                    if(!cargoAnt.equals((String)jComboBox1.getSelectedItem())){
                        try {
                            DatosEmpleados cargoActualizar = new DatosEmpleados();

                            cargoActualizar.setUsuario(tfUsuario.getText());
                            cargoActualizar.setContrasenia(tfContrasenia.getText());
                            cargoActualizar.setCargoNuevo((String)jComboBox1.getSelectedItem());

                            DatosEmpleados cargoActualizado =null;
                            DatosEmpleadosDao d = new DatosEmpleadosDao();

                            cargoActualizado = d.actualizarTelefono(cargoActualizar);
                            ...
                            Logger.getLogger(CargoGUI1.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }else{
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Operador", "Contador", "Auxiliar de Operación" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        jPanel2.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargoGUI1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
