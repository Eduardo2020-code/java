...
public class NombreGUI extends javax.swing.JFrame {
    ...
    public void actualizarNombre() throws SQLException{
        ...
        ArrayList<DatosEmpleados> lista = c.datosModificacionNombre();
        ...
        if(tfUsuario.getText().length()!=0
                ...
                && tfNombreNuevo.getText().length()!=0){
            if(user.equals(tfUsuario.getText())){
                if(contra.equals(tfContrasenia.getText())){
                    if(!nombreAnt.equals(tfNombreNuevo.getText())){
                        try {
                            DatosEmpleados nombreActualizar = new DatosEmpleados();

                            nombreActualizar.setUsuario(tfUsuario.getText());
                            nombreActualizar.setContrasenia(tfContrasenia.getText());
                            nombreActualizar.setNombreNuevo(tfNombreNuevo.getText());

                            DatosEmpleados nombreActualizado =null;
    ...
    public String[][] formatoRegistros(ArrayList<DatosEmpleados> consulta){
        ...
        for (int i = 0; i < consulta.size(); i++) {            
            ...
            registros[i][2] = consulta.get(i).getNombre();
        }
